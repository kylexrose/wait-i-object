...
kyle.address.push(10811);
kyle.address.push('Begonia');
kyle.address.push('Way');
...
const myNewObject = {
  ...
  pet: 'dog',
  catLover: false,
  countries: ['USA', 'Canada', 'Germany', 'Hungary', 'Greece', 'South Korea', 'China', 'Vietnam', 'Philippines'],
  '2chainz' : 'What?'
}
